...
async function updatePostWithSupabaseImages() {
    const slug = 'guia-de-placas-de-transito-contran-o-que-voce-precisa-saber-para-nao-errar'

    const images = {
        a14: 'https://uebewihyttehjdzazsku.supabase.co/storage/v1/object/public/blog-images/A-14.jpg',
        a24: 'https://uebewihyttehjdzazsku.supabase.co/storage/v1/object/public/blog-images/A-24.jpg',
        a30c: 'https://uebewihyttehjdzazsku.supabase.co/storage/v1/object/public/blog-images/A-30c.jpg',
        r1: 'https://uebewihyttehjdzazsku.supabase.co/storage/v1/object/public/blog-images/R-1.jpg',
        r19: 'https://uebewihyttehjdzazsku.supabase.co/storage/v1/object/public/blog-images/R-19.jpg',
        r6a: 'https://uebewihyttehjdzazsku.supabase.co/storage/v1/object/public/blog-images/R-6a%20(Proibido%20Estacionar).jpg'
    }
...
![Placa R-19 Velocidade Máxima](${images.r19})
...
![Placa R-6a Proibido Estacionar](${images.r6a})
...
![Placa A-14 Semáforo](${images.a14})

**Formato:** Losango | **Cor:** Amarelo com símbolo de semáforo colorido

Incorpora as cores verde, amarelo e vermelho para associação cognitiva imediata.

#### A-24 (Obras)

![Placa A-24 Obras](${images.a24})
...
![Placa A-30c Trânsito Compartilhado](${images.a30c})

**Formato:** Losango | **Cor:** Amarelo com símbolos de bicicleta e carro
...
A sinalização vertical não é uma sugestão; é o manual de instruções da via. Respeitá-la é a forma mais eficaz de garantir que todos cheguem ao seu destino com segurança.`
    ...
    console.log('🔄 Atualizando post com imagens do Supabase Storage...')
    ...
    console.log('\n🔗 URL: https://souhabilitado.com/blog/' + slug)
}

updatePostWithSupabaseImages()
