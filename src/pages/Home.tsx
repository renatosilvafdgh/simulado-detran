...
export function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>Simulado Brasil</title>
        <meta
          name="description"
          content="Simulado Brasil: a melhor plataforma de simulados para prova teórica do Detran. Prepare-se com questões atualizadas e simulados completos por estado."
        />
      </Helmet>
