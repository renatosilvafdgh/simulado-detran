...
export function Simulado() {
  ...
  return (
    <>
      <Helmet>
        <title>Simulado Detran - Simulado Brasil</title>
        <meta
          name="description"
          content="Faça simulados completos para prova teórica do Detran por estado. Prepare-se com questões atualizadas e aumente suas chances de aprovação no exame de trânsito."
        />
      </Helmet>
