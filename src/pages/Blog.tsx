...
export function Blog() {
  ...
  return (
    <>
      <Helmet>
        <title>Blog - Simulado Brasil</title>
        <meta
          name="description"
          content="Confira as últimas dicas, novidades e guias completos sobre a prova teórica do Detran no Blog do Simulado Brasil. Tudo para você tirar sua CNH."
        />
      </Helmet>
